...
// Carries no driver of its own — it takes the one the application opened — so the module that names
// SQLite in its SQL does not force SQLite's Rust runtime onto a build that wanted another.
include(":chronik-sqlx4k")
